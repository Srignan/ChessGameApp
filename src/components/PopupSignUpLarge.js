...
const PopupSignUpLarge = ({ onClose }) => {
  ...
  const onPopupImgAvatarIconClick = useCallback(() => {
    window.open("https://www.google.com/");
  }, []);
    ...
    <>
      <div className={styles.popupsignuplarge}>
        ...
        <div className={styles.popupforms}>
          ...
          <b className={styles.popuptextlabelavatar}>
            Click to choose an avatar icon.
          </b>
          <button
            className={styles.popupimgavataricon}
            onClick={onPopupImgAvatarIconClick}
          />
        </div>
        <button
