...
const IndexComputer = () => {
  ...
  const onContent2ButtonHowContainerClick = useCallback(() => {
    navigate("/howtoplay");
  }, [navigate]);
      ...
      <div className={styles.indexcomputer}>
        ...
        <div className={styles.content2}>
          ...
          <div
            ...
            onClick={onContent2ButtonHowContainerClick}
          >
            <button className={styles.content2buttontext}>
              Learn How to Play
            </button>
          </div>
